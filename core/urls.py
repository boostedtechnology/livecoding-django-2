...
urlpatterns = [
    ...
    # Task 1
    path(
        "pets/<uuid:pk>/medical-conditions/<uuid:condition_pk>",
        PetMedicalConditionDestroyView.as_view(),
        name="pet-medical-condition-destroy",
    ),
    path(
        "pets/<uuid:pk>/medical-conditions/",
        PetMedicalConditionListCreateView.as_view(),
        name="pet-medical-condition-list-create",
    ),
    # Task 2
    path("pets/<uuid:pk>/estimate/", PetEstimateView.as_view(), name="pet-estimate"),
    # Task 3
